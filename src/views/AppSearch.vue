<template>
  <!-- top -->
  <div class="w-[96%] ml-[61px] mt-[64px] h-[80px] flex items-center justify-center gap-2">
    <div class="w-[65px] h-[50px] rounded-full flex items-center justify-center bg-gray-200 cursor-pointer">
      <i class="fa-solid fa-sliders text-[20px]"></i>
    </div>
    <div class="w-[120px] h-[48px] rounded-full flex items-center justify-evenly pr-[12px] bg-gray-200 cursor-pointer">
      <img class="w-[38px] h-[38px] rounded-full" src="/public/photo cat.jpg" alt="">
      <p class="font-bold">Secret</p>
    </div>
    <div class="w-[120px] h-[48px] rounded-full flex items-center justify-evenly pr-[12px] bg-gray-200 cursor-pointer">
      <img class="w-[38px] h-[38px] rounded-full" src="/public/photo cat.jpg" alt="">
      <p class="font-bold">Secret</p>
